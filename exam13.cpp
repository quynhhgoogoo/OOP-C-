		...
		switch(choose){
			case 'S':{
				...
				if(found!= 0){
					...
					//file_out_stream.open("registry.txt");
					file_output_stream.write((char *) concerts, sizeof(class concert));
					//file_output_stream<<found->print_values();
			...
			case 'N':{
				...
				cout << "Input name and location of event you want to search: ";
				cin >> name >> location;
				...
				if(found!= 0){
					ofstream file_output_stream(argv[1], ios::app);
					//file_out_stream.open("registry.txt");
					file_output_stream.write((char *) events, sizeof(class event));
					//file_output_stream<<found->print_values();
					...
					cout << "No event with that name and location!" << endl;
				}
			break;
			}
			case 'Q':
