...
class Hotel{
	...
	int num;
public:
	Hotel(string name, string address, int stars, int nums){
		this->name = name;
		this->address = address;
		this->stars = stars;
		this->num = num;
	...
	void getInfo(){
        cout << this->name << " in " << this->address << ". Star: " << this->stars << " with " << this->num << " rooms" << endl;
	}
};
...
int main(void){
	...
	Hotel hotel("Brando Tekla", "Palosaarentie 59", 5, 100);
